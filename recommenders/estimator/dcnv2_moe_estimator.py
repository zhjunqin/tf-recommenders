...
from models import DCNV2MoEModel


class DCNV2MoEEstimator(BaseEstimator):

  def __init__(self, run_config, model_config, flags):
    super(DCNV2MoEEstimator, self).__init__(
  ...
  def build_estimator(self):
    ...
    projection_dim = self._networks['projection_dim']
    ...
    weight_column = None
    self._model= DCNV2MoEModel(label_name=label_name,
