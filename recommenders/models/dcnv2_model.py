...
class DCNV2Model(object):
  ...
  def model_fn(self):
    ...
    def _model_fn(features, labels, mode):
      ...
      tf.logging.info("=DCNV2_Model= input: {}".format(inputs))
      ...
      tf.logging.info("=DCNV2_Model= output: {}".format(output))
